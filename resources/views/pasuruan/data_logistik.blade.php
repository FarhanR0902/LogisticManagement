...
<head>
    ...
    <style>
        ...
        /* FIX: class ini dipakai di <td> Status Bongkar tapi sebelumnya
           tidak pernah didefinisikan di CSS manapun */
        .status-bongkar {
            font-size: 13px;
        }
            ...
            <tbody>
                ...
                @foreach($logistik as $r)
                    ...
                    @php
                        ...
                        // =========================================================
                        // FIX BUG: $rencanaKirimTampil harus dihitung DULU di
                        // sini, sebelum dipakai. Di versi sebelumnya, variabel
                        // ini baru di-assign di BAWAH tempat ia dipakai untuk
                        // menghitung $estimasiAdminPasuruan. Karena variabel
                        // PHP tidak reset otomatis tiap iterasi @foreach, itu
                        // menyebabkan:
                        // - baris pertama: $rencanaKirimTampil undefined
                        // - baris ke-2 dst: yang kepakai adalah nilai sisa
                        //   dari BARIS SEBELUMNYA, bukan baris yang sedang
                        //   diproses -> kolom "Estimasi Admin" dan
                        //   "Ontime/Delay Admin" salah/geser satu baris.
                        // =========================================================
                        ...
                        // ================= ESTIMASI ADMIN =================
                        // (sekarang aman karena $rencanaKirimTampil di atas
                        // sudah pasti nilai milik baris $r yang sedang aktif)
                    ...
                    >
                        ...
                        <td>Rp {{ number_format($r->biaya_kuli_pasuruan ?? 0, 0, ',', '.') }}</td>
                        <td>Rp {{ number_format($r->total_biaya_kuli_pasuruan ?? 0, 0, ',', '.') }}</td>
                        <td>
                            @php
                        ...
                        <td>{{ $estimasiAdminPasuruan ? $estimasiAdminPasuruan->format('d-m-Y') : '-' }}</td>
                        <td>
    ...
    $(document).ready(function() {
        ...
        let table = $('#tableLogistik').DataTable({
            ...
            "drawCallback": function(settings) {
                ...
                // (bisa salah index kalau ada nilai Rp 0 atau kolom Rp lain
                // seperti Biaya Kuli ikut kehitung tanpa sengaja).
                // Sekarang diambil langsung dari data-attribute di <tr>
                // yang sudah pasti benar dan tidak bergantung pada urutan
                // atau jumlah kolom bertanda "Rp".
                // =========================================================
                ...
                // meleset kalau ada penambahan kolom baru (mis. Biaya Kuli
                // Pasuruan / Total Biaya Kuli Pasuruan yang baru ditambah).
                // =========================================================

...
<script src="https://cdn.datatables.net/1.13.8/js/jquery.dataTables.min.js"></script>
    <meta charset="utf-8">
    <title>Customer On Time - Pasuruan</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2>📊 CUSTOMER ON TIME - PASURUAN</h2>
      ...
      <table id="tableCustomerOnTime" class="display nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $row->tanggal_terima_po_pasuruan }}</td>

                        <td>{{ $row->rencana_kirim_pasuruan }}</td>

                        <td>{{ $row->transport_lead_time_pasuruan }}</td>

                        <td>{{ $row->tujuan_pasuruan }}</td>

                        <td>{{ $row->area_pasuruan }}</td>

                        <td>{{ $row->ekspedisi_pasuruan }}</td>

                        <td>{{ $row->tanggal_keluar_gudang_pasuruan }}</td>

                        <td>{{ $row->tanggal_estimasi }}</td>
                        ...
                        <td>{{ $row->reason_waktu_tiba_pasuruan }}</td>

...
<div class="notif-panel">
    <div class="notif-header">🚨 Monitoring Estimasi (≤ 30 Hari)</div>

    <input type="text" class="notif-search" id="notifSearch" placeholder="Search shipment...">

    ...
    <div class="container">
        ...
        <div class="page-header">
            <div class="page-title">
                <div class="eyebrow">Logistik &middot; Jakarta</div>
                <h1>Dashboard pengiriman Jakarta</h1>
            ...
            <form method="GET" action="{{ url()->current() }}" class="filter-form" id="filterForm">
                ...
                <div class="field">
                    ...
                    <select id="f-dist" name="dist_channel">
                        ...
                        <option value="{{ $d->dist_channel }}" {{ request('dist_channel') == $d->dist_channel? 'selected' : '' }}>
                            {{ $d->dist_channel }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="table-scroll">
                    <table>
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="empty-row">Belum ada data tujuan</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    options: {
        ...
        (function isiJumlahAreaPulau() {
            ...
            summaryAreaMapPasuruan.forEach(a => {
                const key = normalisasiNamaPasuruan(a.area);
        ...
        `);
            ...
            if (boundsList.length > 0) {
                shipmentMap.fitBounds(boundsList, {
                    padding: [40, 40]
                });
            }

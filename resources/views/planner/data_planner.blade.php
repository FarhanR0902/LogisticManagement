                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  @php
$statusGudang = strtoupper(trim($r->status_gudang ?? ''));
@endphp

@if($statusGudang == 'ON TIME')
    <span class="badge bg-success">On Time</span>
@elseif($statusGudang == 'DELAY')
    <span class="badge bg-danger">Delay</span>
@else
    <span class="badge bg-secondary">{{ $statusGudang ?: '-' }}</span>
@endif
                                </td>
        ...
        <script>
            $(document).ready(function() {
                ...
                // ========================================================
                $(document).on('input', '.row-nilai-muatan, .row-biaya-kirim, .modal-nilai-muatan, .modal-biaya-kirim', function() {
                    let nilaiInput = $(this).val();
                    $(this).val(formatKeRupiah(nilaiInput));

                    // Jika yang diketik adalah kolom tabel planner, langsung jalankan hitung CR
                    if ($(this).hasClass('row-nilai-muatan') || $(this).hasClass('row-biaya-kirim')) {
                        hitungSemuaCostRatioTabel();
                    }
                });

                    ...
                    <tbody>
                        ...
                        <tr class="autosave-row" data-id="{{ $r->id }}">
                            ...
                            <td><input type="text" form="form-update-{{ $r->id }}" name="pulau" value="{{ $r->pulau }}"></td>
                              ...
                              <td><input type="text" form="form-update-{{ $r->id }}" name="area" value="{{ $r->area }}"></td>
...
if (areaFilter !== '') {
    ...
    return true;
            ...
            function hitungSemuaCostRatioTabel() {
                ...
                dt.rows().every(function() {
                    ...
                    var muatan = ambilAngkaMurni(
                        row.find('.row-nilai-muatan').val()
                    );

                    var biaya = ambilAngkaMurni(
                        row.find('.row-biaya-kirim').val()
                    );
            ...
            } // <<< penutup function hitungSemuaCostRatioTabel()
            // SAMPAI } YG DIATAS
            // ========================================================

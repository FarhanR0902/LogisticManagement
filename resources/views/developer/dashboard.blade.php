...
<form method="GET" action="" style="margin-bottom:20px; display:flex; gap:10px; flex-wrap:wrap;">
    ...
    <button type="submit" style="padding:8px 14px;background:#111827;color:#fff;border-radius:8px;">
        Filter
    </button>
...
<a href="{{ url('/datalogistik') }}" class="card blue">
    <h4>Total Shipment</h4>
    <h1>{{ $total_data }}</h1>
</a>

<a href="{{ route('manager.gudang.ontime') }}" class="card green">
    <h4>Gudang MS OnTime</h4>
    <h1>{{ $gudang_ontime }}</h1>
</a>

<a href="{{ route('manager.gudang.delay') }}" class="card red">
    <h4>Gudang MS Delay</h4>
    <h1>{{ $gudang_delay }}</h1>
</a>

<a href="{{ route('manager.customer.ontime') }}" class="card teal">
    <h4>Tiba Tujuan OnTime</h4>
    <h1>{{ $customer_ontime }}</h1>
</a>

<a href="{{ route('manager.customer.delay') }}" class="card orange">
    <h4>Tiba Tujuan Delay</h4>
    <h1>{{ $customer_delay }}</h1>
</a>

<a href="{{ route('manager.bongkar.ontime') }}" class="card purple">
    <h4>Bongkar OnTime</h4>
    <h1>{{ $bongkar_ontime }}</h1>
</a>

<a href="{{ route('manager.bongkar.delay') }}" class="card dark">
    <h4>Bongkar Delay</h4>
    <h1>{{ $bongkar_delay }}</h1>
</a>
...
const labels = @json($label ?? ['Oncall','Kontrak']);
const values = @json($value ?? [0,0]);

...
<title>SLA TIBA ARMADA DI GUDANG - DELAY</title>
...
<h2>🚨 SLA TIBA ARMADA DI GUDANG - DELAY</h2>
...
<form method="GET">
    ...
    <a href="{{ route('sales.dashboard') }}" class="btn btn-blue">
        ⬅ Dashboard
    </a>
...
@if(isset($logistik) && count($logistik) > 0)

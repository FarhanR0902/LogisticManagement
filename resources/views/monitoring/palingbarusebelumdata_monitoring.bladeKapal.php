...
">
    ...
    <a href="{{ route('spvmonitoring.datalogistik') }}"
        class="{{ request('transportasi') == '' ? 'active' : '' }}">
        📦 SEMUA
    </a>

    <a href="{{ route('spvmonitoring.datalogistik',['transportasi'=>'DARAT']) }}"
        class="{{ request('transportasi') == 'DARAT' ? 'active' : '' }}">
        🚚 DARAT
    </a>

    <a href="{{ route('spvmonitoring.datalogistik',['transportasi'=>'LAUT']) }}"
        class="{{ request('transportasi') == 'LAUT' ? 'active' : '' }}">
        🚢 LAUT
    </a>
        ...
        <div class="filter-box">
            <form method="GET" action="{{ route('spvmonitoring.datalogistik') }}">
                <select class="searchable" name="transportasi" onchange="this.form.submit()">
    <option value="">SEMUA TRANSPORTASI</option>

    <option value="DARAT"
        {{ request('transportasi') == 'DARAT' ? 'selected' : '' }}>
        🚚 DARAT
    </option>

    <option value="LAUT"
        {{ request('transportasi') == 'LAUT' ? 'selected' : '' }}>
        🚢 LAUT
    </option>
</select>
...
<td>
    @if($r->transportasi == 'DARAT')
        <span class="badge green">
            🚚 DARAT
        </span>

    @elseif($r->transportasi == 'LAUT')
...
console.log('SAVE FUNCTION LOADED');
            </script>

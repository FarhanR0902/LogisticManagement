                        ...
                        */
                        ...
                        if ($selisih < 0) {
                            ...
                            {{-- ================= GUDANG 2 ================= --}}
                             ...
                             <td>{{ $r->planning_loading_2 ? date('d-m-Y H:i', strtotime($r->planning_loading_2)) : '-' }}</td>
                            <td>
                            ...
                            {{-- ================= GUDANG 3 ================= --}}
                             <td>{{ $r->planning_loading_3 ? date('d-m-Y H:i', strtotime($r->planning_loading_3)) : '-' }}</td>
                            <td>

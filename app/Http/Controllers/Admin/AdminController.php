...
public function slaOntime(Request $request)
{
    ...
    return view('admin.sla_ontime', compact('list', 'list_area'));
}
...
//     return view('admin.summary_area', compact('summary_area'));
// }
...
if ($row->rencana_kirim && $row->tanggal_dpt_unit) {
    ...
    return view('admin.armada', compact('logistik'));
}
...
public function armadaDelay(Request $request)
{
   $query = DB::table('logistik_pengiriman')
    ...
    return view('admin.armada_delay', compact('logistik'));
}
...
public function belumArmada(Request $request)
{
    ...
    return view('admin.belum_armada', compact('logistik'));
}

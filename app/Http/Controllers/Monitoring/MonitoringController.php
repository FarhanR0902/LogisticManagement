...
class MonitoringController extends Controller
{
    ...
    public function updateMonitoring(Request $request, $id)
    {
        ...
        // $logistik->total_biaya_kuli = ($request->qty_monitoring ?? 0) * ($request->biaya_kuli ?? 0);

        // $logistik->qty_monitoring = $logistik->total_do_qty_car - $logistik->selisih_qty;

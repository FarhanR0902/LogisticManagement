...
$bongkar_delay = (clone $base)
    ...
    ->get();
        ...
        return view('cmd.dashboard', compact(
...
'list_area'
    ...
    */
    ...
    public function gudangOntime(Request $request)
    {
        ...
        return view('cmd.sla_ontime', compact(
            'logistik',
            'list_area'
        ));
    }
   ...
   public function gudangDelay(Request $request)
{
    ...
    return view('cmd.sla_delay', compact(
        'logistik',
        'list_area',
        'title'
    ));
...
public function tujuanOntime(Request $request)
{
    ...
    return view('cmd.tujuan_ontime', compact('logistik', 'list_area'));
}
...
public function tujuanDelay(Request $request)
{
    ...
    return view('cmd.tujuan_delay', compact('logistik', 'list_area'));
}
   ...
   public function tujuanDelaya(Request $request)
{
    ...
    $list_area = $this->getArea();
// dd($query->toRawSql());    
    return view('cmd.tujuan_delay', compact(
        'logistik',
        'list_area'
    ));
}
...
public function bongkarOntime(Request $request)
{
    ...
    return view('cmd.bongkar_ontime', compact('logistik'));
}
public function bongkarDelay(Request $request)
{
    ...
    return view('cmd.bongkar_delay', compact('logistik'));
}
...
public function bongkarDelaya(Request $request)
{
    ...
    return view('cmd.bongkar_delay', compact(
        'logistik'
    ));
}
    ...
    */
    ...
    public function summaryTotal(Request $request)
    {
        ...
        return view('cmd.summary_total', compact(
            'logistik'
        ));
    }
    ...
    */
    ...
    public function summaryArea(Request $request)
    {
        ...
        return view('cmd.summary_area', compact(
            'summary_area'
        ));
    }
